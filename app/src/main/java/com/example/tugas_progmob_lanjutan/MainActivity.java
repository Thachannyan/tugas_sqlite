package com.example.tugas_progmob_lanjutan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(checkupdatedata==true)
                    Toast.makeText(MainActivity.this, "Berhasil diperbaharui", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(MainActivity.this, "Gagal diperbaharui", Toast.LENGTH_SHORT).show();
            }        });
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(res.getCount()==0){
                    Toast.makeText(MainActivity.this, "Tidak ada data tersebut", Toast.LENGTH_SHORT).show();
                    return;
                }
